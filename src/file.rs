/**
 * https://github.com/emilk/egui/issues/270#issuecomment-1468611530
 * https://github.com/kirjavascript/trueLMAO/blob/master/frontend/src/widgets/file.rs
 */
...
impl FileDialog {
    ...
    pub fn save(&self, filename: &str, filedata: FileData) {
        ...
        let file = File::new_with_blob_sequence(
            &blob_parts.into(),
            filename
        ).unwrap();
